...
namespace Academy
{
    public partial class StudentForm : HumanForm
    {
        ...
        {
             //TODO
            int id = labelID.Text.Split(':').Last() == "" ? 0 : Convert.ToInt32(Text.Split(':').Last());
            ...
            {
                DataBase.Connector.Update($"UPDATE Students SET {student.ToStringUpdatee()} WHERE stud_id={student.id}");
            }
